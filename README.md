...
[![CI](https://github.com/cinderblazequest/egxaalnu/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/cinderblazequest/egxaalnu/actions/workflows/ci.yml)
[![Python 3.11 | 3.12](https://img.shields.io/badge/python-3.11%20%7C%203.12-blue)](https://www.python.org/)
[![Coverage ≥70%](https://img.shields.io/badge/coverage-%E2%89%A570%25-brightgreen)](.github/workflows/ci.yml)
[![Code style: ruff](https://img.shields.io/badge/code%20style-ruff-000000)](https://github.com/astral-sh/ruff)
[![License: Apache-2.0](https://img.shields.io/badge/license-Apache--2.0-blue)](LICENSE)
[![152-ФЗ ready](https://img.shields.io/badge/152--ФЗ-ready-success)](docs/governance_152fz.md)
[![Контест](https://img.shields.io/badge/Конкурс-%C2%ABМоя%20страна%20%E2%80%94%20Моя%20Россия%C2%BB%202026-red)](https://moyastrana.ru)
...
2. `/newbot` → имя «СПАС — первая помощь» → username `SPAS_HEALTH_BOT` (или любой свободный).
...
## Max-мессенджер (открытый код, для организаций)

В репозитории также есть **полноценный Max-бот** (мессенджер Max от
VK Group): пошаговое прохождение сценариев, pre/post-тесты,
гамификация, выдача кода сертификата. См. `bot/max/`.

> ⚠ Чтобы зарегистрировать Max-бота через `@MasterBot`, нужно быть
> юридическим лицом (ИП или ООО). Для частных лиц публикация в
> каталоге Max API недоступна. Поэтому Max-версия передаётся как
> open-source ресурс: школа, региональный комитет образования,
> МЧС или любая профильная организация может развернуть бота под
> своим именем по инструкции
> [INSTRUCTIONS_MAX_AND_TELEGRAM.md](INSTRUCTIONS_MAX_AND_TELEGRAM.md).

Запуск Max-версии (если у вас есть `MAX_BOT_TOKEN`):
